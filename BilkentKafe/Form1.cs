...
namespace BilkentKafe
{
    public partial class Form1 : Form
    {
        ...
        private void MasalariOlustur()
        {
            ...
            lvvMasalar.LargeImageList = resimListesi;
            #endregion
        ...
        private void lvvMasalar_DoubleClick(object sender, EventArgs e)
        {
            ListViewItem tiklanan = lvvMasalar.SelectedItems[0];
            ...
            //ve igili masanın sipariş fornumu aç
